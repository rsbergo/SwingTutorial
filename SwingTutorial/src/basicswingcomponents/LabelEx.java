 ...
 * 
 * This example shows the lyrics of a song from Cardigans. HTML tags are used in JLabel component, with <br>
 * tag to separate lines.
 */
public class LabelEx extends JFrame
{
    ...
    private void initUI()
    {
        ...
        // Create a label component. Plain Serif font is chosen and its height is set to 14px.
